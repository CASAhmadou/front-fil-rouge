...
import { GestionGuard } from './_helpers/gestion.guard';
...
const routes: Routes = [
  ...
  { path: 'gestionnaire', loadChildren: () => import(`./gestionnaire/gestionnaire.module`).then(m => m.GestionnaireModule),canActivate:[GestionGuard]},
